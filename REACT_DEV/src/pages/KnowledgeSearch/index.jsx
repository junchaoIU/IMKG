      ...
      <div>
        {val === true ? (
          <div className={styles.indexSearch}>
            ...
            <div style={{height:'50.5vh',padding:10}}>
              <div style={{margin:10}}>
                <span style={{ width: '100',textAlign:'left',margin:30,color:"white",fontSize:17}}>名&emsp; &ensp; 家</span>
                <Select  size="large" style={{ width: '50%'}} mode="tags" placeholder="Tags Mode" onChange={this.handleChangeMingjia}>
                  {this.getmingjia()}
                </Select>
              </div>
              <div style={{margin:10}}>
                <span style={{ width: '100',textAlign:'left',margin:30,color:"white",fontSize:17}}>字&emsp; &ensp; 体</span>
                <Select  size="large" style={{ width: '50%'}} mode="tags" placeholder="Tags Mode" onChange={this.handleChangeZiti}>
                  {this.getziti()}
                </Select>
              </div>
              <div style={{margin:10}}>
                <span style={{ width: '100',textAlign:'left',margin:30,color:"white",fontSize:17}}>来源碑帖</span>
                <Select  size="large" style={{ width: '50%'}} mode="tags" placeholder="Tags Mode" onChange={this.handleChangeBeitie}>
                  {this.getbeitie()}
                </Select>
              </div>
            </div>
